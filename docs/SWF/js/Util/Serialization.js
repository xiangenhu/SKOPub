...
(function (Serialization, undefined) {
	...
	var createFromToken = function (token, context, noChangeOnError){
	...
	*/
		...
		if ((context != null) && (id in context)){
			...
			if (typeof AClass === "undefined"){
                if (noChangeOnError === true){
                    return token;
                } else {
                    throw new Error("Class Factory failed to import " + classId);
                }
			}
			instance = AClass();
		}
    ...
    var nativizeObject = function nativizeObject(obj, context, sFormat){
        ...
        **/ 
        if (Serializable.isInstance(obj)){
            ...
            return createFromToken(obj, context, true);
